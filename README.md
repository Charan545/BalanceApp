...
Overview
BalanceApp is a mobile/web application designed to help users manage their screen time effectively and improve their digital well-being. It offers features     ![Screenshot](Screenshot.jpg)

such as usage tracking, goal setting, and personalized tips.
